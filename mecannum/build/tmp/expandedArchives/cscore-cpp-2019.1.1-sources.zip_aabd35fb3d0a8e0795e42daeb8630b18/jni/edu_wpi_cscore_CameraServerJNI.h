 ...
 * Signature: (II)V
 */
JNIEXPORT void JNICALL Java_edu_wpi_cscore_CameraServerJNI_setSourceConnectionStrategy
  (JNIEnv *, jclass, jint, jint);
 ...
 * Signature: (I)Z
 */
JNIEXPORT jboolean JNICALL Java_edu_wpi_cscore_CameraServerJNI_isSourceEnabled
  (JNIEnv *, jclass, jint);
 ...
 */
JNIEXPORT jboolean JNICALL Java_edu_wpi_cscore_CameraServerJNI_setSourceConfigJson
  (JNIEnv *, jclass, jint, jstring);
 ...
 * Signature: (I)Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_edu_wpi_cscore_CameraServerJNI_getSourceConfigJson
  (JNIEnv *, jclass, jint);
 ...
 * Signature: (I)Ledu/wpi/cscore/UsbCameraInfo;
 */
JNIEXPORT jobject JNICALL Java_edu_wpi_cscore_CameraServerJNI_getUsbCameraInfo
  (JNIEnv *, jclass, jint);
 ...
 * Signature: (ILjava/lang/String;)I
 */
JNIEXPORT jint JNICALL Java_edu_wpi_cscore_CameraServerJNI_getSinkProperty
  (JNIEnv *, jclass, jint, jstring);
 ...
 * Signature: (I)[I
 */
JNIEXPORT jintArray JNICALL Java_edu_wpi_cscore_CameraServerJNI_enumerateSinkProperties
  (JNIEnv *, jclass, jint);
