...
#include "/var/lib/jenkins/workspace/OpenCV/OpenCV - Release/raspbian/opencv/modules/objdetect/include/opencv2/objdetect.hpp"
#include "/var/lib/jenkins/workspace/OpenCV/OpenCV - Release/raspbian/opencv/modules/objdetect/include/opencv2/objdetect/detection_based_tracker.hpp"
  ...
  (JNIEnv* env, jclass , jlong self, jlong img_nativeObj, jlong points_nativeObj, jlong straight_qrcode_nativeObj)
{
    ...
    try {
        ...
        cv::String _retval_ = me->decode( img, points, straight_qrcode );
  ...
  (JNIEnv* env, jclass , jlong self, jlong img_nativeObj, jlong points_nativeObj)
{
    ...
    try {
        ...
        Mat& img = *((Mat*)img_nativeObj);
        Mat& points = *((Mat*)points_nativeObj);
        cv::String _retval_ = me->decode( img, points );
        return env->NewStringUTF(_retval_.c_str());
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self, jlong img_nativeObj, jlong points_nativeObj, jlong straight_qrcode_nativeObj)
{
    ...
    try {
        ...
        Mat& points = *((Mat*)points_nativeObj);
        Mat& straight_qrcode = *((Mat*)straight_qrcode_nativeObj);
        cv::String _retval_ = me->detectAndDecode( img, points, straight_qrcode );
        return env->NewStringUTF(_retval_.c_str());
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self, jlong img_nativeObj, jlong points_nativeObj)
{
    ...
    try {
        ...
        Mat& img = *((Mat*)img_nativeObj);
        Mat& points = *((Mat*)points_nativeObj);
        cv::String _retval_ = me->detectAndDecode( img, points );
        return env->NewStringUTF(_retval_.c_str());
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
  ...
  (JNIEnv* env, jclass , jlong self, jlong img_nativeObj)
{
    ...
    try {
        ...
        cv::QRCodeDetector* me = (cv::QRCodeDetector*) self; //TODO: check for NULL
        Mat& img = *((Mat*)img_nativeObj);
        cv::String _retval_ = me->detectAndDecode( img );
        return env->NewStringUTF(_retval_.c_str());
    } catch(const std::exception &e) {
        throwJavaException(env, &e, method_name);
    } catch (...) {
